...
class RCNN(nn.Module):
    def __init__(self, batch_size, output_size, hidden_size, vocab_size, embedding_length, weights):
        ...
        output_size : 2 = (biased,non biased)
    ...
    def forward(self, input_sentence, batch_size=None):
        ...
        Returns
        -------
        Output of the linear layer containing logits for biased and non biased class which receives its input as the final_hidden_state of the LSTM
